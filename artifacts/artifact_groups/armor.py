...
class Armor(Artifact):
    ...
    """
    def __init__(self, grade_modifier, armor_type, prefix, suffix, game_mode):
    ...
    def get_armor(self, grade_modifier: float) -> int:
        ...
        """
        base_armor = tuple(global_artifacts_cursor.execute(f'''
...
WHERE art_type_name == '{self.art_type}'
    ...
    def get_speed_bonus(self) -> int:
        ...
        """
        base_speed_mod = tuple(global_artifacts_cursor.execute(f'''
    ...
    def get_evasion(self):
        ...
        :return: int число с параметром бонуса/штрафа
        """
        base_evasion = tuple(global_artifacts_cursor.execute(f'''
