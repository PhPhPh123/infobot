...
from economic_news.mini_quests import QuestFactory, choise_quest_group, control_quests, Quest, RewardMixin, ArtifactQuest, KillQuest, \
    DeliveryQuest
...
def test_control_quests(monkeypatch):
    ...
    monkeypatch.setattr('economic_news.mini_quests.ArtifactQuest.load_artifact_to_log', mock_load_artifact_to_log)

    def mock_load_quest_to_log(*args, **kwargs):
        return None

    monkeypatch.setattr('economic_news.mini_quests.Quest.load_quest_to_log', mock_load_quest_to_log)
