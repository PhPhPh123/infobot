...
game_session_commands = """
Команды игровой сессии

Админские:
!start_game_session *игровые часы текущей сессии* - записывает информацию о проводящейся в данный момент игровой сессии

Общие
!display_sessions_stat *month или week* - выводит линейный график о часах проведенных в игре в разрезе недель или месяцев
"""
