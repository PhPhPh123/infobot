...
из папки additinal_files в_.txt переименовав в `.env`. Каждое из трёх значений в файле нужно заполнить полученными из приложения discord данными токена, id
и имени.
#### Пример: 
```
