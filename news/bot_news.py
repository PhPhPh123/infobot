...
def str_form_enemy_news(enemy_tuple):
    ...
    warning_messages = ['Будьте внимательнее, путешествуя на этот мир',
                        ...
                        'Путешествую в данный мир будьте готовы к столкновению с врагами человечества',
    ...
    peace_messages = ['Блажен тот кто верует',
                      ...
                      'Враги могут скрываться даже не внешне благополучном мире. Нашли еретика или предателя? Доложите немедленно']
